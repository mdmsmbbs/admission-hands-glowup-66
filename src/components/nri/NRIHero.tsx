...
const NRIHero = () => {
  return (
    <section className="relative bg-gradient-to-b from-medical-50 to-white py-20 overflow-hidden">
      <div className="absolute inset-0 bg-[url('/nri-pattern.svg')] opacity-5"></div>
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 animate-fade-up">
            <div className="inline-block px-4 py-2 bg-medical-100 text-medical-800 rounded-full text-sm font-medium">
          ...
          <div className="relative h-[400px] lg:h-[550px]">
            ...
            />
            <div className="absolute bottom-6 left-6 right-6 bg-white/80 backdrop-blur-sm p-5 rounded-xl shadow-lg">
              <div className="flex items-start gap-4">
                <div className="bg-medical-600 text-white p-3 rounded-lg">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 4V20M4 12H20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-gray-900">Why Choose NRI Quota?</h3>
                  <p className="text-gray-700">Higher chances of admission with specialized seats reserved exclusively for NRI candidates.</p>
                </div>
              </div>
            </div>
          </div>
