      ...
      <div className="container-custom">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-6">
          <div className="w-full lg:w-1/2">
            ...
            <Button 
              className="bg-white text-medical-600 hover:bg-gray-100 font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-md transition-all shadow-md hover:shadow-lg flex items-center text-sm sm:text-base"
