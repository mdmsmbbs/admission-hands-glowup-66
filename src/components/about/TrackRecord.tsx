  ...
  return (
    <div className="py-4 bg-white">
      <div className="container-custom">
        <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 text-center">Our Track Record</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
          <div className="p-3 rounded-xl bg-medical-50 hover:shadow-md transition-shadow text-center">
          ...
          <div className="p-3 rounded-xl bg-teal-50 hover:shadow-md transition-shadow text-center">
            <div className="h-20 mb-2 overflow-hidden rounded-lg">
              <img
          ...
          <div className="p-3 rounded-xl bg-amber-50 hover:shadow-md transition-shadow text-center">
            <div className="h-20 mb-2 overflow-hidden rounded-lg">
              <img
          ...
          <div className="p-3 rounded-xl bg-blue-50 hover:shadow-md transition-shadow text-center">
            <div className="h-20 mb-2 overflow-hidden rounded-lg">
              <img
